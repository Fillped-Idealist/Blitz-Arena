...
export default function NumberGuessGame({ onComplete, onCancel }: NumberGuessGameProps) {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const metadata = [attempts];
      const gameHash = computeHash(0, score, timestamp, metadata);
