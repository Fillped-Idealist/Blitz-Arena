// GameFactory ABI (简化版，只包含主要函数)
export const GAME_FACTORY_ABI = [
  {
    "inputs": [
      {
        "internalType": "address",
        "name": "blitzTokenAddress",
        "type": "address"
      }
    ],
    ...
    "inputs": [
      {
        "components": [
          ...
          {
            "internalType": "enum Types.PrizeDistributionType",
        ...
        "internalType": "struct Types.GameConfig",
        "name": "config",
        "type": "tuple"
      }
    ],
...
export const GAME_INSTANCE_ABI = [
  ...
  },
  {
    ...
    "outputs": [
      {
        "internalType": "struct Types.PlayerInfo[]",
        "name": "",
        "type": "tuple[]"
      }
    ],
